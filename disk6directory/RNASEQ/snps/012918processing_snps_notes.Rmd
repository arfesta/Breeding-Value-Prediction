...
## 6. Merge and Sort biological reps into final bam
...
```linux
 bcftools merge --threads 60 ./EW/bio.sort.rmdup/msd.wrg/ew.bam.freebayes.out.vcf.gz ./LGEP/bio.sort.rmdup/msd.wrg/lgep.bam.freebayes.out.vcf.gz  > 192.biorep.vcf.gz
 
 bgzip -c ./192.biorep.vcf.gz > ./192.biorep.vcf.bgzip.gz
 
 tabix 192.biorep.vcf.gz
 ```
 
``` linux
vcftools --gzvcf ./ew.bam.freebayes.out.vcf.gz --remove-indels --max-missing 1.0 --maf 0.05 --min-meanDP 10  --012 
```
