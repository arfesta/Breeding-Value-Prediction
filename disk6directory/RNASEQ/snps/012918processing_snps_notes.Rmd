...
```
***Note: Once finished, unsorted and duplicated bam technical reps were deleted.  The newly cread bam files within the ./sort.rmdup were then moved in place of the deleted unsorted and duplicated bams.
