...
library(readxl);library(asreml);library(parallel)
```
...
```{r}
  pedigree <-read_xlsx("./disk6directory/resources/pedigree/pedigree_2018_04_19_20_36_15.xlsx")
```
...
save(asreml.counts,file = "../Step3_LMM_Counts.RData",compress=T)
```